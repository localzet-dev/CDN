...
var ChartsWidget1 = function () {
    ...
    var initChart = function() {
        var element = document.getElementById("charts_widget_1");

        if (!element) {
            return;
        }

        var negativeColor = element.hasAttribute('data-negative-color') ? element.getAttribute('data-negative-color') : Util.getCssVariableValue('--bs-success');
