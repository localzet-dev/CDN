...
var ChartsWidget41 = function () {
    ...
    return {
        init: function () {   
            ...
            initChart(chart1, '#charts_widget_41_tab_1', '#charts_widget_41_chart_1', chart1Data, chart1Labels, true);
            ...
            initChart(chart2, '#charts_widget_41_tab_2', '#charts_widget_41_chart_2', chart2Data, chart2Labels, false);
            ...
            initChart(chart3, '#charts_widget_41_tab_3', '#charts_widget_41_chart_3', chart3Data, chart3Labels, false);
            ...
            initChart(chart4, '#charts_widget_41_tab_4', '#charts_widget_41_chart_4', chart4Data, chart4Labels, false);                
            ...
            initChart(chart5, '#charts_widget_41_tab_5', '#charts_widget_41_chart_5', chart5Data, chart5Labels, false);
            ...
            ThemeMode.on("kt.thememode.change", function() {
                ...
                initChart(chart1, '#charts_widget_41_tab_1', '#charts_widget_41_chart_1', chart1Data, chart1Labels, chart1.rendered);
                initChart(chart2, '#charts_widget_41_tab_2', '#charts_widget_41_chart_2', chart2Data, chart2Labels, chart2.rendered);  
                initChart(chart3, '#charts_widget_41_tab_3', '#charts_widget_41_chart_3', chart3Data, chart3Labels, chart3.rendered);
                initChart(chart4, '#charts_widget_41_tab_4', '#charts_widget_41_chart_4', chart4Data, chart4Labels, chart4.rendered); 
                initChart(chart5, '#charts_widget_41_tab_5', '#charts_widget_41_chart_5', chart5Data, chart5Labels, chart5.rendered); 
            });
        }   
    }
}();
