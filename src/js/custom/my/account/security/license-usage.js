...
// Определение класса
var AccountSecurityLicenseUsage = function () {
    // Приватные методы
    var initLicenceCopy = function() {
        Util.each(document.querySelectorAll('#security_license_usage_table [data-action="copy"]'), function(button) {
...
Util.onDOMContentLoaded(function() {
    AccountSecurityLicenseUsage.init();
});
