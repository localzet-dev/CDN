...
var ModalNewTarget = function () {
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#modal_new_target');
			...
			form = document.querySelector('#modal_new_target_form');
			submitButton = document.getElementById('modal_new_target_submit');
			cancelButton = document.getElementById('modal_new_target_cancel');
