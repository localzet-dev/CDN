...
// Определение класса
var ModalCreateApiKey = function () {
	var submitButton;
	var cancelButton;
	var validator;
	var form;
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#modal_create_api_key');
			...
			form = document.querySelector('#modal_create_api_key_form');
			submitButton = document.getElementById('modal_create_api_key_submit');
			cancelButton = document.getElementById('modal_create_api_key_cancel');
