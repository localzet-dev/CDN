...
// Определение класса
var ModalOfferADealDetails = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	return {
		...
		init: function () {
			...
			nextButton = ModalOfferADeal.getStepper().querySelector('[data-element="details-next"]');
			previousButton = ModalOfferADeal.getStepper().querySelector('[data-element="details-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.ModalOfferADealDetails = module.exports = ModalOfferADealDetails;
}