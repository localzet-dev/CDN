...
// Определение класса
var ModalOfferADealType = function () {
	// Variables
	var nextButton;
	var validator;
	var form;
	...
	return {
		...
		init: function () {
			...
			nextButton = ModalOfferADeal.getStepper().querySelector('[data-element="type-next"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.ModalOfferADealType = module.exports = ModalOfferADealType;
}