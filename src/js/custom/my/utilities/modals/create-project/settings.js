...
// Определение класса
var ModalCreateProjectSettings = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	var initForm = function() {
		...
		var myDropzone = new Dropzone("#modal_create_project_settings_logo", { 
	...
	return {
		...
		init: function () {
			...
			nextButton = ModalCreateProject.getStepper().querySelector('[data-element="settings-next"]');
			previousButton = ModalCreateProject.getStepper().querySelector('[data-element="settings-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.ModalCreateProjectSettings = module.exports = ModalCreateProjectSettings;
}
