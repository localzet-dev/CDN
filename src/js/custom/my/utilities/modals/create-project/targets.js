...
// Определение класса
var ModalCreateProjectTargets = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	return {
		...
		init: function () {
			...
			nextButton = ModalCreateProject.getStepper().querySelector('[data-element="targets-next"]');
			previousButton = ModalCreateProject.getStepper().querySelector('[data-element="targets-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.ModalCreateProjectTargets = module.exports = ModalCreateProjectTargets;
}