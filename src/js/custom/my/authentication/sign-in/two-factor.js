...
var SigninTwoFactor = function() {
    ...
    return {
        // Initialization
        init: function() {
            form = document.querySelector('#sing_in_two_factor_form');
            submitButton = document.querySelector('#sing_in_two_factor_submit');
