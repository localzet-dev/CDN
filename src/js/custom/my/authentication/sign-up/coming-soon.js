...
var SignupComingSoon = function() {
    ...
    return {
        // public functions
        init: function() {
            form = document.querySelector('#coming_soon_form');
            submitButton = document.querySelector('#coming_soon_submit');
           
            handleForm();

            counterDays = document.querySelector('#coming_soon_counter_days');
            if (counterDays) {                
                counterHours = document.querySelector('#coming_soon_counter_hours');
                counterMinutes = document.querySelector('#coming_soon_counter_minutes');
                counterSeconds = document.querySelector('#coming_soon_counter_seconds');
