...
// Определение класса
var UsersAddOneTimePassword = function () {
    // Shared variables
    const element = document.getElementById('modal_add_one_time_password');
    const form = element.querySelector('#modal_add_one_time_password_form');
