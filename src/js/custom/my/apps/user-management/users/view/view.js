...
// Определение класса
var UsersViewMain = function () {

    // Init login session button
    var initLoginSession = () => {
        const button = document.getElementById('modal_sign_out_sesions');
    ...
    var initSignOutUser = () => {
        const signOutButtons = document.querySelectorAll('[data-users-sign-out="single_user"]');
    ...
    const initDeleteTwoStep = () => {
        const deleteButton = document.getElementById('users_delete_two_step');
    ...
    const initEmailPreferenceForm = () => {
        // Define variables
        const form = document.getElementById('users_email_notification_form');
        const submitButton = form.querySelector('#users_email_notification_submit');
        const cancelButton = form.querySelector('#users_email_notification_cancel');
