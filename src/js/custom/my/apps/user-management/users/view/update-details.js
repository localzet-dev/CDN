...
// Определение класса
var UsersUpdateDetails = function () {
    // Shared variables
    const element = document.getElementById('modal_update_details');
    const form = element.querySelector('#modal_update_user_form');
