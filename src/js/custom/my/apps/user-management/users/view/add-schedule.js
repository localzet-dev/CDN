...
// Определение класса
var UsersAddSchedule = function () {
    // Shared variables
    const element = document.getElementById('modal_add_schedule');
    const form = element.querySelector('#modal_add_schedule_form');
    ...
    var initAddSchedule = () => {       
        ...
        $("#modal_add_schedule_datepicker").flatpickr({
            enableTime: true,
            dateFormat: "Y-m-d H:i",
        });

        // Init tagify -- for more info: https://yaireo.github.io/tagify/
        const tagifyInput = form.querySelector('#modal_add_schedule_tagify');
