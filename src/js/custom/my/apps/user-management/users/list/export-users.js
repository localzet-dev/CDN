...
// Определение класса
var ModalExportUsers = function () {
    // Shared variables
    const element = document.getElementById('modal_export_users');
    const form = element.querySelector('#modal_export_users_form');
