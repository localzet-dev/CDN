...
var UsersList = function () {
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-users-table-filter="delete_row"]');
    ...
    var initToggleToolbar = () => {
        ...
        // Select elements
        toolbarBase = document.querySelector('[data-user-table-toolbar="base"]');
        toolbarSelected = document.querySelector('[data-user-table-toolbar="selected"]');
        selectedCount = document.querySelector('[data-user-table-select="selected_count"]');
        const deleteSelected = document.querySelector('[data-user-table-select="delete_selected"]');
