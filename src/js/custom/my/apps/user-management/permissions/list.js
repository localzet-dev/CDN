...
// Определение класса
var UsersPermissionsList = function () {
    // Shared variables
    var datatable;
    var table;
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-permissions-table-filter="search"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-permissions-table-filter="delete_row"]');
