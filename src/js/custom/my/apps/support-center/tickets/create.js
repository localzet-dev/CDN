...
var ModalNewTicket = function () {
	...
	var initForm = function() {
		...
		var myDropzone = new Dropzone("#modal_create_ticket_attachments", { 
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#modal_new_ticket');
			...
			form = document.querySelector('#modal_new_ticket_form');
			submitButton = document.getElementById('modal_new_ticket_submit');
			cancelButton = document.getElementById('modal_new_ticket_cancel');
