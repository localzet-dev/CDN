...
// Определение класса
var ModalAdjustBalance = function () {
    var element;
    var submitButton;
    var cancelButton;
    var closeButton;
    ...
    var initForm = function () {
        ...
        Inputmask("US$ 9,999,999.99", {
            "numericInput": true
        }).mask("#modal_inputmask");
    }

    var handleBalanceCalculator = function () {
        // Select elements
        const currentBalance = element.querySelector('[modal-adjust-balance="current_balance"]');
        newBalance = element.querySelector('[modal-adjust-balance="new_balance"]');
        maskInput = document.getElementById('modal_inputmask');
    ...
    return {
        ...
        init: function () {
            // Elements
            element = document.querySelector('#modal_adjust_balance');
            modal = new bootstrap.Modal(element);

            form = element.querySelector('#modal_adjust_balance_form');
            submitButton = form.querySelector('#modal_adjust_balance_submit');
            cancelButton = form.querySelector('#modal_adjust_balance_cancel');
            closeButton = element.querySelector('#modal_adjust_balance_close');
