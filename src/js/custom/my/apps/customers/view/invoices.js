...
var CustomerViewInvoices = function () {
    ...
    var initInvoiceYear2020 = function () {
        // Define table element
        const id = '#customer_details_invoices_table_2';
        var table = document.querySelector(id);
    ...
    var initInvoiceYear2019 = function () {
        // Define table element
        const id = '#customer_details_invoices_table_3';
        var table = document.querySelector(id);
    ...
    var initInvoiceYear2018 = function () {
        // Define table element
        const id = '#customer_details_invoices_table_4';
        var table = document.querySelector(id);
