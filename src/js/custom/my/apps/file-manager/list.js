...
var FileManagerList = function () {
    ...
    // Приватные методы
    const initTemplates = () => {
        uploadTemplate = document.querySelector('[data-filemanager-template="upload"]');
        renameTemplate = document.querySelector('[data-filemanager-template="rename"]');
        actionTemplate = document.querySelector('[data-filemanager-template="action"]');
        checkboxTemplate = document.querySelector('[data-filemanager-template="checkbox"]');
    }
    ...
    const initDatatable = () => {
        ...
        var loadOptions;
        if (table.getAttribute('data-filemanager-table') === 'folders') {
    ...
    const handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-filemanager-table-filter="search"]');
    ...
    const handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-filemanager-table-filter="delete_row"]');
    ...
    const initToggleToolbar = () => {
        ...
        if (table.getAttribute('data-filemanager-table') === 'folders') {
            checkboxes = document.querySelectorAll('#file_manager_list_wrapper [type="checkbox"]');
        }

        // Select elements
        const deleteSelected = document.querySelector('[data-filemanager-table-select="delete_selected"]');
    ...
    const toggleToolbars = () => {
        // Define variables
        const toolbarBase = document.querySelector('[data-filemanager-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-filemanager-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-filemanager-table-select="selected_count"]');
    ...
    const handleNewFolder = () => {
        // Select button
        const newFolder = document.getElementById('file_manager_new_folder');
        ...
        newFolder.addEventListener('click', e => {
            ...
            if (table.querySelector('#file_manager_new_folder_row')) {
                return;
            }
            ...
            const rowForm = rowElement.querySelector('#file_manager_add_folder_form');
            const rowButton = rowElement.querySelector('#file_manager_add_folder');
            const cancelButton = rowElement.querySelector('#file_manager_cancel_folder');
            const folderIcon = rowElement.querySelector('#file_manager_folder_icon');
            ...
            rowButton.addEventListener('click', e => {
                ...
                // Activate indicator
                rowButton.setAttribute("data-indicator", "on");
                    ...
                    validator.validate().then(function (status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            setTimeout(function () {
                                ...
                                $(newRow).find('td').eq(4).attr('data-filemanager-table', 'action_dropdown');
                                ...
                                // Disable indicator
                                rowButton.removeAttribute("data-indicator");
            ...
            cancelButton.addEventListener('click', e => {
                ...
                // Activate indicator
                cancelButton.setAttribute("data-indicator", "on");

                setTimeout(function () {
                    // Disable indicator
                    cancelButton.removeAttribute("data-indicator");
    ...
    const resetNewFolder = () => {
        const newFolderRow = table.querySelector('#file_manager_new_folder_row');
    ...
    const handleRename = () => {
        const renameButton = table.querySelectorAll('[data-filemanager-table="rename"]');     
    ...
    const renameCallback = (e) => {
        ...
        if (table.querySelectorAll('#file_manager_rename_input').length > 0) {
            Swal.fire({
        ...
        renameInput.querySelector('#file_manager_rename_folder_icon').innerHTML = colIcon.outerHTML;
        ...
        parent.querySelector('#file_manager_rename_input').value = nameValue;
        ...
        const renameInputButton = document.querySelector('#file_manager_rename_folder');
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                Swal.fire({
                                    ...
                                    const newValue = document.querySelector('#file_manager_rename_input').value;
        ...
        // Cancel rename input
        const cancelInputButton = document.querySelector('#file_manager_rename_folder_cancel');
        cancelInputButton.addEventListener('click', e => {
            e.preventDefault();

            // Simulate process for demo only
            cancelInputButton.setAttribute("data-indicator", "on");
            ...
            setTimeout(function () {
                ...
                // Remove spinner
                cancelInputButton.removeAttribute("data-indicator");
    ...
    const initDropzone = () => {
        ...
        const id = "#modal_upload_dropzone";
    ...
    const initCopyLink = () => {
        ...
        const elements = table.querySelectorAll('[data-filemanger-table="copy_link"]');

        elements.forEach(el => {
            // Define elements
            const button = el.querySelector('button');
            const generator = el.querySelector('[data-filemanger-table="copy_link_generator"]');
            const result = el.querySelector('[data-filemanger-table="copy_link_result"]');
    ...
    const handleMoveToFolder = () => {
        const element = document.querySelector('#modal_move_to_folder');
        const form = element.querySelector('#modal_move_to_folder_form');
        const saveButton = form.querySelector('#modal_move_to_folder_submit');
    ...
    const countTotalItems = () => {
        const counter = document.getElementById('file_manager_items_counter');
    ...
    return {
        init: function () {
            table = document.querySelector('#file_manager_list');
