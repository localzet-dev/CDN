...
var ProjectOverview = function () {
    // Colors
    var primary = Util.getCssVariableValue('--bs-primary');
    var lightPrimary = Util.getCssVariableValue('--bs-primary-light');
    var success = Util.getCssVariableValue('--bs-success');
    var lightSuccess = Util.getCssVariableValue('--bs-success-light');
    var gray200 = Util.getCssVariableValue('--bs-gray-200');
    var gray500 = Util.getCssVariableValue('--bs-gray-500');
    ...
    var initGraph = function () {
        var element = document.getElementById("project_overview_graph");
    ...
    var initTable = function () {
        var table = document.querySelector('#profile_overview_table');
        ...
        const filterOrders = document.getElementById('filter_orders');
