...
var SubscriptionsAdvanced = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initCustomFieldsDatatable = function () {
        // Define variables
        const addButton = document.getElementById('create_new_custom_fields_add');
    ...
    var deleteCustomField = function() {
        Util.on(table, '[data-action="field_remove"]', 'click', function(e) {
            e.preventDefault();
    ...
    return {
        init: function () {
            table = document.getElementById('create_new_custom_fields');
