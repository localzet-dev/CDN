...
var AppContactEdit = function () {
    ...
    const initForm = () => {
        // Select form
        const form = document.getElementById('ecommerce_settings_general_form');
        ...
        const submitButton = form.querySelector('[data-contacts-type="submit"]');
    ...
    const initSelect2Flags = () => {
        ...
        var optionFormat = function(item) {
            ...
            template += '<img src="' + item.element.getAttribute('data-select2-country') + '" class="rounded-circle me-2" style="height:19px;" alt="image"/>';
            template += item.text;
