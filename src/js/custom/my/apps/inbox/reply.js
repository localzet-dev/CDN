...
// Определение класса
var AppInboxReply = function () {

    // Приватные методы
    const handlePreviewText = () => {
        // Get all messages
        const accordions = document.querySelectorAll('[data-inbox-message="message_wrapper"]');
        accordions.forEach(accordion => {
            // Set variables
            const header = accordion.querySelector('[data-inbox-message="header"]');
            const previewText = accordion.querySelector('[data-inbox-message="preview"]');
            const details = accordion.querySelector('[data-inbox-message="details"]');
            const message = accordion.querySelector('[data-inbox-message="message"]');
            ...
            header.addEventListener('click', e => {
                // Return if Menu or buttons are clicked
                if (e.target.closest('[data-menu-trigger="click"]') || e.target.closest('.btn')) {
                    return;
                } else {
    ...
    const initForm = () => {
        // Set variables
        const form = document.querySelector('#inbox_reply_form');
        const allTagify = form.querySelectorAll('[data-inbox-form="tagify"]');
    ...
    const handleCCandBCC = (el) => {
        // Get elements
        const ccElement = el.querySelector('[data-inbox-form="cc"]');
        const ccButton = el.querySelector('[data-inbox-form="cc_button"]');
        const ccClose = el.querySelector('[data-inbox-form="cc_close"]');
        const bccElement = el.querySelector('[data-inbox-form="bcc"]');
        const bccButton = el.querySelector('[data-inbox-form="bcc_button"]');
        const bccClose = el.querySelector('[data-inbox-form="bcc_close"]');
    ...
    const handleSubmit = (el) => {
        const submitButton = el.querySelector('[data-inbox-form="send"]');
    ...
    const initDropzone = (el) => {
        ...
        const id = '[data-inbox-form="dropzone"]';
        const dropzone = el.querySelector(id);
        const uploadButton = el.querySelector('[data-inbox-form="dropzone_upload"]');
