...
const themes = {};
for (const path of glob('src/css/themes/*.css')) {
...
export default {
  ...
  entry: {
    index: [
      fileURLToPath(new URL('src/js/jquery.js', import.meta.url)),
      fileURLToPath(new URL('src/fomantic/build/semantic.js', import.meta.url)),
      fileURLToPath(new URL('src/js/index.js', import.meta.url)),
      fileURLToPath(new URL('node_modules/easymde/dist/easymde.min.css', import.meta.url)),
      fileURLToPath(new URL('src/fomantic/build/semantic.css', import.meta.url)),
      fileURLToPath(new URL('src/css/index.css', import.meta.url)),
    ],
    webcomponents: [
      fileURLToPath(new URL('src/js/webcomponents/webcomponents.js', import.meta.url)),
    ],
    swagger: [
      fileURLToPath(new URL('src/js/standalone/swagger.js', import.meta.url)),
      fileURLToPath(new URL('src/css/standalone/swagger.css', import.meta.url)),
    ],
    'eventsource.sharedworker': [
      fileURLToPath(new URL('src/js/features/eventsource.sharedworker.js', import.meta.url)),
    ],
    ...(!isProduction && {
      devtest: [
        fileURLToPath(new URL('src/js/standalone/devtest.js', import.meta.url)),
        fileURLToPath(new URL('src/css/standalone/devtest.css', import.meta.url)),
      ],
    }),
    ...themes,
  },
  devtool: false,
  output: {
    path: fileURLToPath(new URL('../public/git/assets', import.meta.url)),
    filename: () => 'js/[name].js',
    chunkFilename: ({chunk}) => {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.svg$/i,
        include: fileURLToPath(new URL('../public/git/assets/img/svg', import.meta.url)),
        type: 'asset/source',
      },
      {
        test: /\.(ttf|woff2?)$/i,
  ...
  plugins: [
    ...
    isProduction ? new LicenseCheckerWebpackPlugin({
      ...
      outputWriter: ({dependencies}) => {
        ...
        const goJson = readFileSync('src/go-licenses.json', 'utf8');
